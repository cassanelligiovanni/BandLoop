...
namespace BinaryData
{
    ...
    extern const char*   BarPlayingOn_svg;
    const int            BarPlayingOn_svgSize = 9557;

    extern const char*   BarRecordingOff_svg;
    const int            BarRecordingOff_svgSize = 6100;
    ...
    extern const char*   one_wav;
    const int            one_wavSize = 26552;

    extern const char*   two_wav;
    const int            two_wavSize = 17360;
